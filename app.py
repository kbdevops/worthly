...
def _create_initial_snapshots_json():
    """One-time: create snapshots.json from hardcoded historical data."""
    data = [
        # FY2021
        ("2021-03-01", 19736, 72967),
        ("2021-04-01", 20156, 69130),
        ("2021-05-01", 22695, 75859),
        ("2021-06-01", 24752, 80398),
        # FY2022
        ("2021-07-01", 26550, 85715),
        ("2021-08-01", 28557, 92611),
        ("2021-09-01", 30533, 95288),
        ("2021-10-01", 32010, 100331),
        ("2021-11-01", 33659, 103394),
        ("2021-12-01", 35265, 111451),
        ("2022-01-01", 38450, 114335),
        ("2022-02-01", 40526, 112757),
        ("2022-03-01", 42437, 114689),
        ("2022-04-01", 47004, 112207),
        ("2022-05-01", 48643, 107916),
        ("2022-06-01", 50680, 105881),
        # FY2023
        ("2022-07-01", 51016, 102476),
        ("2022-08-01", 56475, 105224),
        ("2022-09-01", 59537, 96592),
        ("2022-10-01", 60061, 91862),
        ("2022-11-01", 64262, 104598),
        ("2022-12-01", 73521, 117404),
        ("2023-01-01", 75203, 119284),
        ("2023-02-01", 79537, 119544),
        ("2023-03-01", 82216, 122684),
        ("2023-04-01", 86768, 129327),
        ("2023-05-01", 91172, 100207),
        ("2023-06-01", 94382, 84705),
        # FY2024
        ("2023-07-01", 100663, 83147),
        ("2023-08-01", 104668, 68245),
        ("2023-09-01", 105753, 53587),
        ("2023-10-01", 105643, 56605),
        ("2023-11-01", 106751, 60892),
        ("2023-12-01", 112280, 65600),
        ("2024-01-01", 121778, 67684),
        ("2024-02-01", 125873, 82860),
        ("2024-03-01", 129500, 89387),
        ("2024-04-01", 134953, 97907),
        ("2024-05-01", 134197, 96331),
        ("2024-06-01", 136952, 107428),
        # FY2025
        ("2024-07-01", 140960, 113876),
        ("2024-08-01", 145712, 117804),
        ("2024-09-01", 150322, 104284),
        ("2024-10-01", 156980, 119606),
        ("2024-11-01", 160036, 144588),
        ("2024-12-01", 167581, 150515),
        ("2025-01-01", 168391, 134977),
        ("2025-02-01", 174176, 120928),
        ("2025-03-01", 171710, 116777),
        ("2025-04-01", 169139, 105537),
        ("2025-05-01", 171382, 95465),
        ("2025-06-01", 187233, 104290),
        # FY2026 (Jul 2025 – Jun 2026)
        ("2025-07-01", 193250, 79789),
        ("2025-08-01", 200903, 53849),
        ("2025-09-01", 207024, 41855),
        ("2025-10-01", 210256, 54067),
        ("2025-11-01", 218351, 40210),
        ("2025-12-01", 222438, 50985),
        ("2026-01-01", 224313, 36134),
        ("2026-02-01", 225080, 34224),
        ("2026-03-01", 230261, 38050),
        ("2026-04-01", 219370, 36363),
        ("2026-05-01", 232263, 30804),
        ("2026-06-01", 242007, 19654),
        # FY2027 (Jul 2026 – Jun 2027)
        ("2026-07-01", 251790, 167410),
        ("2026-08-01", 252276, 86529),
    ]
    # Write to JSON file
    json_data = [{"date": d, "super": s, "cash": c} for d, s, c in data]
    with open(SNAPSHOT_FILE, "w", encoding="utf-8") as f:
        json.dump(json_data, f, indent=2)
    print(f"[backend] Created snapshots.json with {len(json_data)} historical entries.")
